...
function ListarProductos(){
    ...
    .then(data => {
        ...
        data.forEach(element => {
            ...
            codigo += '<div class="col-4" style="max-width: 540px;">'
            codigo += '    <div class="card mb-2 p-2 shadow">'
            codigo += '        <div class="row g-0">'
            codigo += '            <div class="col-md-4">'
            codigo += '                <img src="img/Camisetas/CF'+element._id+'.png" class="img-fluid rounded-start" alt="...">'
            codigo += '            </div>'
            codigo += '            <div class="col-md-8">'
            codigo += '            <div class="card-body">'
            codigo += '                <h5 class="card-title">'+element.product_name+'</h5>'
            codigo += '                <p class="card-text">'+element.product_description+'</p>'
